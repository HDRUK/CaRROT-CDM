...
for _id in ['8507','378253','40305063','4060225']:
    ...
    for relationship in relationships:
        if relationship=="Mapped from":
            ...
            concept_id=df2['concept_id_1'].iloc[relationships.index(relationship)]
            destination_table = df['domain_id'].iloc[relationships.index(relationship)]
        elif relationship=="Concept same_as to":
            is_standard="Non-Standard"
            non_standard_concept_id=df2['concept_id_1'].iloc[relationships.index(relationship)]
            concept_id=df2['concept_id_2'].iloc[relationships.index(relationship)]
            destination_table = df['domain_id'].iloc[0]
    print("Mapping is: ",is_standard)
    print("Stardard Mapping is: ",concept_id)
