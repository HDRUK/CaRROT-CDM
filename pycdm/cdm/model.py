...
from pycdm.tools.logger import Logger
from pycdm.tools.profiling import Profiler
import pycdm.tools 
...
class CommonDataModel(Logger):
    ...
    def __init__(self, name=None, omop_version='5.3.1',
        ...
        #     'observation':
        #     {
        #         'observation_0': <pycdm.cdm.objects.observation.Observation object 0x000>,
        #         'observation_1': <pycdm.cdm.objects.observation.Observation object 0x001>,
        #     },
        #     'measurement':
        #     {
        #         'measurement_0': <pycdm.cdm.objects.measurement.Measurement object 0x000>,
        #         ...
        #     }
        #     ...
        # }
    ...
    def create_and_add_objects(self,config):
        ...
        for destination_table,rules_set in config['cdm'].items():
            ...
            for name,rules in rules_set.items():
                ...
                obj.define = lambda x,rules=rules : pycdm.tools.apply_rules(x,rules,inputs=self.inputs)
