...
class VisitOccurrence(DestinationTable):
    ...
    def __init__(self):
        ...
        self.visit_start_datetime          = DestinationField(dtype="DATETIME"    , required=False)
        self.visit_end_date                = DestinationField(dtype="DATE"        , required=True)
        self.visit_end_datetime            = DestinationField(dtype="DATETIME"    , required=False)
        ...
        self.visit_source_value            = DestinationField(dtype="VARCHAR(50)" , required=False)
        ...
        self.admitting_source_value        = DestinationField(dtype="VARCHAR(50)" , required=False)
        self.discharge_to_concept_id       = DestinationField(dtype="INTEGER"     , required=False)
        self.discharge_to_source_value     = DestinationField(dtype="VARCHAR(50)" , required=False)
